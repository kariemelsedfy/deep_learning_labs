...
#show example plots of clothing images
"""
...
nn.Conv2d(1, 64, 3, stride=1, padding=0, bias=True)
torch.nn.MaxPool2d(3, stride=None, padding=0)
...
#displays a summary of the changes in each operation
